...
namespace IT703_A2_TomiveCorp_HotelManagement.Controllers
{
    public class VenuesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VenueId,Name,Location,Phone,PreviewImage")] Venue venue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueId,Name,Location,Phone,PreviewImage")] Venue venue)
        {
            if (id != venue.VenueId)
            {
                return NotFound();
